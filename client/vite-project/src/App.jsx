...
export default function App() {
  ...
  const handleUpload = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch("https://lexvisionv2-2.onrender.com/analyze", { method: "POST", body: formData });
  ...
  const handleWhatIf = async () => {
    ...
    try {
      ...
      const response = await fetch("https://lexvisionv2-2.onrender.com/whatif", { method: "POST", body: formData });
      const data = await response.json();
